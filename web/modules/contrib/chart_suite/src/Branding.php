...
final class Branding {
   ...
   * @var string
   */
  const MODULE_BRANDING_LIBRARY = 'chart_suite/chart_suite.branding';
  ...
  public static function addFieldFormatterBranding(array &$form) {
    ...
    $module = \Drupal::moduleHandler()->getModule('chart_suite');
    ...
    $wrapperClass = 'chart_suite-field-formatter-settings';
    $logoClass = 'chart_suite-branding-logo';
  ...
  public static function getBannerBranding() {
    ...
    // Define some CSS classes.
    $containerClass = 'chart_suite-banner-branding';
    $logoClass = 'chart_suite-branding-logo';
